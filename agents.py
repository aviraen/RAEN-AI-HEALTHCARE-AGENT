...
# Title
st.title("RAEN AI HEALTHCARE AGENT")


# Text Inputs
gender = st.selectbox('Select Gender', ('Male', 'Female', 'Other'))
age = st.number_input('Enter Age', min_value=0, max_value=120, value=25)
symptoms = st.text_area('Enter Symptoms', 'e.g., fever')
medical_history = st.text_area('Enter Medical History', 'e.g., diabetes, hypertension,stress')
